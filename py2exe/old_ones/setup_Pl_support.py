...
Mydata_files = [('', ["smd.ico"])]
#build_exe_options = {"optimize": 1,"icon" : 'smd.ico'}
#base = "Win32GUI"

setup(
        name="RT",
        windows=[{"script":"get_stat_from_db.py","file_resources": ["",], 'icon_resources': [ (1, 'smd.ico'),]}],
        #data_files = Mydata_files,
        options={"py2exe":{"ascii":0,"bundle_files": 1,"compressed": True, "optimize": 1,"includes":["time"],"dll_excludes": ["MSVCP90.dll", "HID.DLL", "w9xpopen.exe"],}},
	zipfile=None,
        )
